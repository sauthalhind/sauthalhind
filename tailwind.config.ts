  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        bodyLg: ['var(--font-arabic)', 'sans-serif'],
        bodyMd: ['var(--font-arabic)', 'sans-serif'],
        headlineXl: ['var(--font-kufi)', 'sans-serif'],
        headlineLg: ['var(--font-kufi)', 'sans-serif'],
        headlineMd: ['var(--font-kufi)', 'sans-serif'],
        displayLg: ['var(--font-kufi)', 'sans-serif'],
