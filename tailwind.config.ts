...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        amiri: ['var(--font-amiri)', 'var(--font-naskh)', 'serif'],
        naskh: ['var(--font-naskh)', 'var(--font-amiri)', 'serif'],
        cairo: ['var(--font-cairo)', 'sans-serif'],
        arabic: ['var(--font-amiri)', 'var(--font-naskh)', 'serif'],
        english: ['var(--font-english)', 'sans-serif'],
        bodyLg: ['var(--font-naskh)', 'serif'],
        bodyMd: ['var(--font-naskh)', 'serif'],
        headlineXl: ['var(--font-amiri)', 'var(--font-naskh)', 'serif'],
        headlineLg: ['var(--font-amiri)', 'var(--font-naskh)', 'serif'],
        headlineMd: ['var(--font-amiri)', 'var(--font-naskh)', 'serif'],
        displayLg: ['var(--font-amiri)', 'var(--font-naskh)', 'serif'],
