...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        cairo: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
        malayalam: ['var(--font-malayalam)', 'var(--font-cairo)', 'sans-serif'],
        arabic: ['var(--font-cairo)', 'sans-serif'],
        english: ['var(--font-english)', 'sans-serif'],
        sans: ['var(--font-cairo)', 'var(--font-malayalam)', 'var(--font-english)', 'system-ui', '-apple-system', 'sans-serif'],
        bodyLg: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
        bodyMd: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
        headlineXl: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
        headlineLg: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
        headlineMd: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
        displayLg: ['var(--font-cairo)', 'var(--font-malayalam)', 'sans-serif'],
