      ...
      <Container className="py-6 sm:py-12">
        <div className="max-w-3xl mx-auto bg-white p-5 sm:p-8 border border-gray-200 rounded-sm shadow-sm">
          ...
          <div className="prose prose-sm sm:prose text-gray-700 leading-relaxed sm:leading-loose space-y-4">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mt-6 mb-2">1. حقوق النشر والملكية الفكرية</h3>
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mt-6 mb-2">2. الاستخدام المقبول</h3>
            <p>توافق على استخدام الموقع لأغراض قانونية فقط، وتجنب أي تصرف قد يعطل عمل الموقع أو يؤثر على تجربة المستخدمين الآخرين.</p>
            
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mt-6 mb-2">3. دقة المعلومات</h3>
            <p>نحن نسعى جاهدين لتقديم معلومات صحيحة ودقيقة، ولكننا لا نتحمل أي مسؤولية عن أي أخطاء أو سهو في المحتوى المقدم.</p>
            
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mt-6 mb-2">4. الروابط الخارجية</h3>
            <p>قد يحتوي الموقع على روابط لمواقع خارجية. نحن غير مسؤولين عن محتوى تلك المواقع أو سياسات الخصوصية الخاصة بها.</p>
            
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mt-6 mb-2">5. التعديلات</h3>
